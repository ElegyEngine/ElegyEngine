...
// https://github.com/godotengine/godot/blob/master/modules/mono/glue/GodotSharp/GodotSharp/Core/Vector3I.cs
...
namespace Elegy.Common.Maths
{
	...
	public struct Vector3I : IEquatable<Vector3I>
	{
		...
		/// <summary>
		/// X-facing unit vector. <c>(1 0 0)</c>
		/// </summary>
		public static Vector3I UnitX => new( 1, 0, 0 );
		/// <summary>
		/// Y-facing unit vector. <c>(0 1 0)</c>
		/// </summary>
		public static Vector3I UnitY => new( 0, 1, 0 );
		/// <summary>
		/// Z-facing unit vector. <c>(0 0 1)</c>
		/// </summary>
