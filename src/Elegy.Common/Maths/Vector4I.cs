...
namespace Elegy.Common.Maths
{
	...
	public struct Vector4I : IEquatable<Vector4I>
	{
		...
		public static Vector4I MinValue => new( int.MinValue, int.MinValue, int.MinValue, int.MinValue );
		/// <summary>
		...
		public static Vector4I MaxValue => new( int.MaxValue, int.MaxValue, int.MaxValue, int.MaxValue );
